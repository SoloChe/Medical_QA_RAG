...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='./models/lora_finetuned', help='Directory to save the LoRA fine-tuned model')
    ...
    parser.add_argument('--wandb_project', type=str, default='Medical_QA_LoRA', help='Wandb project name')
