...
class RAGPipeline:
    def __init__(self,
        ...
        self.contextualizer = Contextualizer(model_name=context_model_name, top_k=top_k_con, device=device)
    ...
    def run(self, query, top_k_ret=3, max_new_tokens_gen=100, do_sample_gen=False, summarize=True):
